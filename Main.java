...
//        Parent roo = FXMLLoader.load(getClass().getResource("sample.fxml"));
//        primaryStage.setTitle("Colour Switch Game");
//
//        Image image = new Image(new FileInputStream("src\\colorswitch2.jpg"));
//        BackgroundImage myBI= new BackgroundImage(image, BackgroundRepeat.REPEAT, BackgroundRepeat.REPEAT, BackgroundPosition.DEFAULT, BackgroundSize.DEFAULT);
//        Background mbi=new Background(myBI);
...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        //URL resource = getClass().getResource("Ipsi.mp3");
